from ryu.lib.packet import packet, icmp, arp, ethernet, ipv6, ipv4, tcp, udp, vlan
from network import IPAddr, EthAddr
...
class VlanValidator(Validator):
    ...
    def validate_pyretic_packet(self, obj, pkt):
        ...
        try:
            return 'vlan_id' in pkt
        except:
            return False

        try:
            return 'vlan_pcp' in pkt
        except:
            return False
