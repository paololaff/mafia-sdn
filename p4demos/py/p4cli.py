...
class P4CLI(object):
    ...
    def register_read(self, register):
        ...
        try:
            output = subprocess.check_output(['./scripts/cli_read_register.sh', self.path, self.json, self.thrift_port, register])
    ...
    def register_read_index(self, register, index):
        ...
        try:
            output = subprocess.check_output(['./scripts/cli_read_register_index.sh', self.path, self.json, self.thrift_port, register, index])
    ...
    def counter_read(self, counter):
        ...
        try:
            output = subprocess.check_output(['./scripts/cli_read_counter.sh', self.path, self.json, self.thrift_port, counter])
    ...
    def counter_read_index(self, counter, index):
        ...
        try:
            output = subprocess.check_output(['./scripts/cli_read_counter_index.sh', self.path, self.json, self.thrift_port, counter, index])
